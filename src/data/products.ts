...
export const products: Product[] = [
  {
    ...
    category: "salads",
    image: salad,
    gallery: [salad, americanGreensDiet, peachIcedTea, healthyGardenFitCombo],
    price: 249,
    mrp: 329,
    rating: 4.8,
    reviews: 214,
  ...
  },
  {
    ...
    gallery: [americanGreensDiet, spicyInfernoDiet, creamyVegDelight, avocadoCrunchDiet],
    price: 119,
    mrp: 159,
    rating: 4.8,
    reviews: 312,
  ...
  },
  {
    ...
    category: "iced-tea",
    image: peachIcedTea,
    gallery: [peachIcedTea, lemonBasilIcedTea, berryHibiscusIcedTea, passionFruitIcedTea],
    price: 129,
    mrp: 169,
    rating: 4.8,
    reviews: 218,
  ...
  },
  {
    ...
    category: "footlong",
    image: footlong,
    gallery: [footlong, americanGreensDiet, salad, paneerCombo],
    price: 349,
    mrp: 449,
    rating: 4.9,
    reviews: 302,
  ...
  },
  {
    ...
    image: salad,
    gallery: [salad, peachIcedTea, americanGreensDiet, healthyGardenFitCombo],
    price: 199,
    mrp: 259,
    rating: 4.5,
    reviews: 96,
  ...
  },
  {
    ...
    gallery: [healthyGardenFitCombo, salad, lemonBasilIcedTea, berryHibiscusIcedTea],
    price: 299,
    mrp: 379,
    rating: 4.6,
    reviews: 112,
  ...
  },
  {
    ...
    gallery: [spicyInfernoDiet, americanGreensDiet, creamyVegDelight, avocadoCrunchDiet],
    price: 119,
    mrp: 159,
    rating: 4.7,
    reviews: 245,
  ...
  },
  {
    ...
    gallery: [lemonBasilIcedTea, peachIcedTea, berryHibiscusIcedTea, matchaMintIcedTea],
    price: 119,
    mrp: 159,
    rating: 4.7,
    reviews: 142,
  ...
  },
  {
    ...
    gallery: [berryHibiscusIcedTea, peachIcedTea, passionFruitIcedTea, matchaMintIcedTea],
    price: 139,
    mrp: 179,
    rating: 4.8,
    reviews: 94,
  ...
  },
  {
    ...
    gallery: [passionFruitIcedTea, peachIcedTea, berryHibiscusIcedTea, lemonBasilIcedTea],
    price: 149,
    mrp: 189,
    rating: 4.9,
    reviews: 167,
  ...
  },
  {
    ...
    gallery: [matchaMintIcedTea, lemonBasilIcedTea, peachIcedTea, berryHibiscusIcedTea],
    price: 159,
    mrp: 199,
    rating: 4.6,
    reviews: 78,
  ...
  },
  {
    ...
    gallery: [creamyVegDelight, americanGreensDiet, spicyInfernoDiet, avocadoCrunchDiet],
    price: 119,
    mrp: 159,
    rating: 4.8,
    reviews: 198,
  ...
  },
  {
    ...
    gallery: [avocadoCrunchDiet, americanGreensDiet, spicyInfernoDiet, creamyVegDelight],
    price: 149,
    mrp: 189,
    rating: 4.9,
    reviews: 284,
